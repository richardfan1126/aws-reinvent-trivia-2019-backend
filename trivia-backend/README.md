...
```
aws ssm put-parameter --region us-east-1 --name CertificateArn-demo-api.richardfan.xyz --type String --value arn:aws:acm:...

aws ssm put-parameter --region us-east-1 --name CertificateArn-demo-api-test.richardfan.xyz --type String --value arn:aws:acm:...
